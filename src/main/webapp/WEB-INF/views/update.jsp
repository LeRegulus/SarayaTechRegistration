    ...
    <form action="/student.do" method="post">
        <div class="row">
            <div class="form-group col">
                ...
                <input type="text" class="form-control" name="firstname" value="<%=student.getFirstname()%>"/>
            </div>
            <div class="form-group col">
                <label>LastName</label>
                <input type="text" class="form-control" name="lastName" value="<%=student.getLastname()%>"/>
            </div>
            <div class="form-group col">
                <label>Date of Birth</label>
                <input type="date" class="form-control" name="dateofbirth" value="<%=student.getDateOfBirth()%>"/>
            </div>
            <div class="form-group col">
                <label>Training Duration</label>
                <select class="form-control" value="<%=student.getTrainingDuration()%>" name="training">
